...
```{r, echo=FALSE, message=FALSE, error=FALSE}
intro.results <- data.frame(c("MLE - 3gram (no dictionary)", "MLE - 2gram (no dictionary)", "MLE - 1gram (no dictionary)", "MLE - 3gram (dictionary)", "MLE - 2gram (dictionary)", "MLE - 1gram (dictionary)", "Modified Kneser Ney - 3gram (no dictionary)", "Modified Kneser Ney - 3gram (dictionary)"), c("%", "%", "%", "%", "%", "%", "%", "%"), c("%", "%", "%", "%", "%", "%", "%", "%"), c("%", "%", "%", "%", "%", "%", "%", "%"),  c("%", "%", "%", "%", "%", "%", "%", "%"))
names(intro.results) <- c("Model", "Perplexity - Exc. OOV", "OOV", "Perplexity - Inc. OOV", "Accuracy")
rownames(intro.results) <- NULL
library(knitr)
corpus.summary <- kable(intro.results)
return(corpus.summary)
